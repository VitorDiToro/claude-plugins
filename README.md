...
| `revisor-academico` | 1.7.0 | Editorial review of academic LaTeX reports (ABNT/Inatel-aware, falls back to the document's own pattern), reported as Markdown. | [docs/revisor-academico.md](docs/revisor-academico.md) *(pt-BR)* |
...
| `revisor-academico` | 1.7.0 | Revisão editorial de relatórios acadêmicos em LaTeX (reconhece ABNT/Inatel, com fallback ao padrão do documento), entregue em Markdown. | [docs/revisor-academico.md](docs/revisor-academico.md) |
